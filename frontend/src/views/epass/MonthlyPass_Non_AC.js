...
function MonthlyPass_Non_AC() {
  useEffect(() => {

    const date = new Date();
    const year = date.getFullYear();
    const month = date.getMonth() + 1;
    const day_next = date.getDate() + 30;
  ...
  const handlepay = () => {
    ...
    var pass_id = "BMTC_MP_Non_AC_" + rand;
    ...
    const result = fetch(`http://localhost:9000/ePass_details/Monthly_ePass_${busType}`, {
      method: "POST",
      headers: {
    ...
    window.location.href = "/admin/epass/viewMonthlyPass_Non_AC";
  ...
  const [busType, setbusType] = useState("Non_AC");
          ...
          <Col md="4">
            <Card className="card-user">
              ...
              <Col className="pr-1" md="12">
                ...
                {/* <NavLink to="/admin/epass/viewMonthlyPass_Non_AC"> */}
                <Button
                  defaultValue="view"
                  placeholder="buy"
                  type="button"
...
export default MonthlyPass_Non_AC;
