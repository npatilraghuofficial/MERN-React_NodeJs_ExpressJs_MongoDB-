...
const Map = ({paths, stops})=> {
    ...
    const getDistance = () => {
        ...
        const differentInTime = (new Date() - initialDate) / 30; // pass to seconds
    ...
    const startSimulation = useCallback(
        () => {
            ...
            interval = window.setInterval(moveObject, 10);
        },
    ...
    const mapUpdate = () => {
        ...
        if (nextLine) {
            ...
            point1 = progress[progress.length - 5];
            point2 = progress[progress.length - 2];
        }
