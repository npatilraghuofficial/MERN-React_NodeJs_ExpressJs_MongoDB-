...
function ViewDailyPass_Non_AC() {
  ...
  const fetchdata = async () => {
    ...
    result.then((json) => {
      ...
      const passdetails = json.data[0].ePass_details.Daily_ePass_Non_AC;
      const Pass_id = json.data[0].ePass_details.Daily_ePass_Non_AC.Pass_id;

      const Doc_number = json.data[0].ePass_details.Daily_ePass_Non_AC.DocNumber;

      const expiry = json.data[0].ePass_details.Daily_ePass_Non_AC.ExpiryDate;
      const Purchase = json.data[0].ePass_details.Daily_ePass_Non_AC.logindate;

      const Fare = json.data[0].ePass_details.Daily_ePass_Non_AC.Fare;
      ...
      const expirydateparsed = parseInt(expirydate[1]);
      console.log("Pass Expiry parsed date" + expirydateparsed);
      const currentdateparsed = parseInt(currentdate_[1]);
      console.log("Pass currrent  parsed date" + currentdateparsed);
      if ((expiry === current_system_date) || (expirydateparsed <= currentdateparsed) || expiry === "0") {
        setValidPass(false);
    ...
    // sessionStorage.setItem("user_pass_type", Daily_ePass_Non_AC);
    sessionStorage.setItem("Verify_Pass_Type", "ScanVerifyPass_Daily_ePass_Non_AC");
  ...
  return (
    ...
    <div className="container">
      {validPass && (<>
        <h1>My Daily-Pass Non AC <img src={require("assets/img/bus_ticket_green_small.png")} class="img-responsive" alt="..." />
        </h1>
        <table class="table table-bordered table-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="4"><li>BasicCharge = 45</li>
                <li> Service Charge = 20</li>
                <li>Tax = 5</li> <li>others = 5</li> </td>
              <td> </td>
...
export default ViewDailyPass_Non_AC
