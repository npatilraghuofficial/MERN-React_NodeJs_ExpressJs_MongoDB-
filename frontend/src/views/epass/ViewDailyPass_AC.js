...
function ViewDailyPass_AC() {
  ...
  const fetchdata = async () => {
    ...
    result.then((json) => {
      ...
      const Pass_id = json.data[0].ePass_details.Daily_ePass_AC.Pass_id;

      const Doc_number = json.data[0].ePass_details.Daily_ePass_AC.DocNumber;

      const expiry = json.data[0].ePass_details.Daily_ePass_AC.ExpiryDate;
      const Purchase = json.data[0].ePass_details.Daily_ePass_AC.logindate;

      const Fare = json.data[0].ePass_details.Daily_ePass_AC.Fare;
  ...
  return (
    ...
    <div className="container">
      {validPass && (<>
        <h1>My Daily-Pass AC <img src={require("assets/img/bus_ticket_green_small.png")} class="img-responsive" alt="..." />
        </h1>
        <table class="table table-bordered table-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="4"><li>BasicCharge = 70</li>
...
export default ViewDailyPass_AC
