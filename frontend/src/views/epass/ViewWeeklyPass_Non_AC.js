...
function ViewWeeklyPass_Non_AC() {
  ...
  const fetchdata = async () => {
    ...
    result.then((json) => {
      ...
      const passdetails = json.data[0].ePass_details.Weekly_ePass_Non_AC;
      const Pass_id = json.data[0].ePass_details.Weekly_ePass_Non_AC.Pass_id;

      const Doc_number = json.data[0].ePass_details.Weekly_ePass_Non_AC.DocNumber;

      const expiry = json.data[0].ePass_details.Weekly_ePass_Non_AC.ExpiryDate;
      const Purchase = json.data[0].ePass_details.Weekly_ePass_Non_AC.logindate;

      const Fare = json.data[0].ePass_details.Weekly_ePass_Non_AC.Fare;
    ...
    // sessionStorage.setItem("user_pass_type", Weekly_ePass_Non_AC);
    sessionStorage.setItem("Verify_Pass_Type", "ScanVerifyPass_Weekly_ePass_Non_AC");
  ...
  return (
    ...
    <div className="container">
      {validPass && (<>
        <h1>My Weekly-Pass  Non-AC <img src={require("assets/img/bus_ticket_blue_small.png")} class="img-responsive" alt="..." />
        </h1>
        <table class="table table-bordered table-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="4"><li>BasicCharge = 300</li>
...
export default ViewWeeklyPass_Non_AC
