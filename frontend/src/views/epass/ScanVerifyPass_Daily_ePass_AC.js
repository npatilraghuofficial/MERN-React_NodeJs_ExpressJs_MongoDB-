...
function ScanVerifyPass_Daily_ePass_AC() {
    useEffect(() => {
        ...
        const res = fetch("http://localhost:9000/user/ScanAndVerifyPass_Daily_ePass_AC", {

            // D:\A_FINAL_MCA_PROJECT\abcpro\frontend\src\views\epass\ScanVerifyPass_Daily_ePass_AC_Daily_ePass_AC.js
            method: "POST",
            headers: {
...
export default ScanVerifyPass_Daily_ePass_AC
