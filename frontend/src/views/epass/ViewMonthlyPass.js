...
function ViewMonthlyPass() {
  ...
  const fetchdata = async () => {
    ...
    result.then((json) => {
      ...
      const passdetails = json.data[0].ePass_details.Monthly_ePass_AC;
      const Pass_id = json.data[0].ePass_details.Monthly_ePass_AC.Pass_id;

      const Doc_number = json.data[0].ePass_details.Monthly_ePass_AC.DocNumber;

      const expiry = json.data[0].ePass_details.Monthly_ePass_AC.ExpiryDate;
      const Purchase = json.data[0].ePass_details.Monthly_ePass_AC.logindate;

      const Fare = json.data[0].ePass_details.Monthly_ePass_AC.Fare;
    ...
    // sessionStorage.setItem("user_pass_type", Monthly_ePass_AC);
    sessionStorage.setItem("Verify_Pass_Type", "ScanVerifyPass_Monthly_ePass_AC");
  ...
  return (
    ...
    <div className="container">
      {validPass && (<>
        <h1>My Monthly-Pass AC <img src={require("assets/img/bus_ticket_orange_small.png")} class="img-responsive" alt="..." />
        </h1>
        <table class="table table-bordered table-responsive">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="4"><li>BasicCharge = 2900</li>
                <li> Service Charge = 40</li>
                <li>Tax = 20</li> <li>others = 40</li> </td>
              <td> </td>
...
export default ViewMonthlyPass
