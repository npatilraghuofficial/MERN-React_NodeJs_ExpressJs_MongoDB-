...
class ConductorLogin extends React.Component {
  ...
  //       res = fetch("http://localhost:9000/ConductorLogin", {
   ...
   const check = fetch("http://localhost:9000/checkloginForManager", {
    ...
    body: JSON.stringify({
      ...
      if (res.status === 200) {
        ...
        const res2 = fetch("http://localhost:9000/conductorlogin", {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
          },
        ...
        window.location.href = "/admin/conductor/ConductorDashboard";
